 ...
 */
public class EntityProxyGenerator<K extends Serializable, V extends IEntity<K>> {
    ...
    public EntityProxyGenerator(EntityCache<K, V> entityCache, Class<V> entityClass) {
        this.entityCache = entityCache;
        this.constructor = getConstructor(entityClass);
    }

    public V generate(V entity) throws Exception {
